...
const Brand = () => {
  ...
  return (
    <div className='flex flex-wrap justify-center md:justify-between lg:flex-nowrap items-center bg-white rounded-sm shadow-shadowLight -mt-8 max-w-[95%] md:max-w-[1276px] py-6 md:py-8 px-4 md:px-16 mx-auto lg:mx-0 lg:ml-auto'>
      {imgs.map((img, index) => (
        <Image
