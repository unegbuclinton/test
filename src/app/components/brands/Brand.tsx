...
const Brand = () => {
  ...
  return (
    <div className='flex flex-wrap justify-center md:justify-between items-center bg-white rounded-sm shadow-shadowLight -mt-8 max-w-[95%] md:max-w-[1276px] py-6 md:py-8 px-4 md:px-16 mx-auto'>
      {imgs.map((img, index) => (
        <Image
